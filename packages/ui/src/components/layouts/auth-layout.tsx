      ...
      <div className="grid min-h-dvh lg:grid-cols-5">
        <aside className="fixed inset-y-0 col-span-2 hidden w-2/5 lg:block">
          {imageSrc ? (
            ...
            <div className="absolute inset-0 bg-[radial-gradient(at_18%_8%,oklch(0.55_0.12_85)_0%,transparent_55%),radial-gradient(at_82%_92%,oklch(0.38_0.07_60)_0%,transparent_55%),radial-gradient(at_55%_45%,oklch(0.3_0.04_75)_0%,transparent_60%),oklch(0.15_0.012_70)]" />
          )}
